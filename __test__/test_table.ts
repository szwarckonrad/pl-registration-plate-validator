...
export const testTable: ITestTableEntry[] = [
    ...
    {label: "too long suffix for 2 letter prefix", plate: "WU 123456", result: false},
    ...
    {label: "3 chars vanity suffix with first char being a number", plate: "E9 1AB", result: false},
    ...
    {label: "5 chars vanity suffix with not  last two chars being a number", plate: "W0 123AB", result: false},
];
